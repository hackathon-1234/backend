...
-- INSERT INTO users(first_name, last_name, login, email, password, year_of_birth, time_of_registration, role)
-- VALUES
-- -- Пароль у всех "12345"
-- ('Джек', 'Смит', 'jack23', 'jack@mail.com', '$2a$10$sINGL2w4dlvwVsQ.Z7wt0.BmMMDal7HRum31Ax91wwdr4v6HUAF6a',
--  '2000-10-20', '2022-07-01 20:05:06', 'ROLE_USER'),
-- ('Иван', 'Иванов', 'ivan45', 'ivan@mail.com', '$2a$10$sINGL2w4dlvwVsQ.Z7wt0.BmMMDal7HRum31Ax91wwdr4v6HUAF6a',
--  '2003-11-20', '2022-07-03 20:03:06', 'ROLE_USER'),
-- ('Майк', 'Джексон', 'mike2', 'mike@mail.com', '$2a$10$sINGL2w4dlvwVsQ.Z7wt0.BmMMDal7HRum31Ax91wwdr4v6HUAF6a',
--  '1981-10-20', '2022-07-02 16:00:06', 'ROLE_TEACHER'),
-- ('Эндрю', 'Пол', 'andrew3', 'andrew@mail.com', '$2a$10$sINGL2w4dlvwVsQ.Z7wt0.BmMMDal7HRum31Ax91wwdr4v6HUAF6a',
--  '1995-10-20', '2022-07-08 04:05:06', 'ROLE_ADMIN');
--
--
-- INSERT INTO test_category(title)
-- VALUES ('Математика'),
--        ('Биология'),
--        ('Информатика'),
--        ('Русский язык'),
...
--        ('История');
--
-- INSERT INTO tests(title, category_id, count_of_questions, date_of_creation, users_id)
-- VALUES ('Анатомия', 2, 2, '2023-03-01', 3),
--        ('Математика 11 класс', 1, 3, '2023-03-03', 3),
--        ('Астрономия', 5, 3, '2023-03-04', 3),
--        ('Русский язык для 8 класса', 4, 3, '2023-03-05', 3);
--
--
-- INSERT INTO questions (title, number_of_question, correct_answer_id, first_answer, second_answer, third_answer,
--                        fourth_answer, tests_id)
-- VALUES ('First question of Biology', 1, 3, 'first', 'second', 'thirdR', 'fourth', 1),
...
--
-- INSERT INTO decisions(users_id, tests_id, time_of_decision, count_of_right_answers, count_of_all_answers)
-- VALUES (1, 1, '2023-03-05 04:05:06', 1, 2),
